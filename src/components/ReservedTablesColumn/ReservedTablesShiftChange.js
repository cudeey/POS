...
const ReservedTablesShiftChange = ({ filterFree }) => {
  const dispatch = useDispatch();

  const dataReservation =
    useSelector((state) => state.apiGetReservation.data) || [];
      ...
      {dataReservation[0]
        ...
        .map((item) => (
          <div key={item.id} className="pb-10 pt-3">
            <div className="w-full rounded-lg shadow-md h-157 flex items-center justify-center">
...
export default ReservedTablesShiftChange;
