...
const DropdownIngredients = ({
  ...
  useEffect(() => {
    if (selectedOption) {
      setSelectedIngredientName(selectedOption.ingredients);
    }
  }, [selectedOption]);
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div className="block w-40 h-12 relative rounded-lg border-0 px-2.5 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        <p
